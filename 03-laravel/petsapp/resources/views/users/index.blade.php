...
<!-- Authentication -->
<h1 class="text-3xl flex gap-2 items-center text-white mb-10 pb-2 border-b-2">
...
<ul class="menu menu-vertical gap-1 lg:menu-horizontal bg-base-200 rounded-box">
    <li><a href="{{ url('users/create') }}" class="btn btn-sm sm:btn-md btn-success btn-outline">
...
<div class="overflow-x-auto my-2 rounded-box bg-base-100">
  <table class="table">
    ...
    <thead>
      <tr>
        <th>Fullname</th>
        <th class="sm:table-cell hidden">Rol</th>
