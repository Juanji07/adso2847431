...
<body class="bg-teal-700 flex text-teal-200 flex-col gap-8 justify-center min-h-[100dvh] items-center">
    <h1 class="font-bold border-b-2 text-4xl">List All Users <small class="text-teal-400 text-lg">Factory Challenge</small></h1>
